 ...
 * This version doesn't include the document inline to support efficient caching
 */
 ...
 * This separates the document from the chunk instructions to support efficient caching.
 *
 * @param chunkContent - The content of the specific chunk to be contextualized.
 ...
 * Returns structured data that supports efficient caching.
 *
